...
if __name__=="__main__":
    ...
    plt.scatter(attributes1, attributes2, s=10, marker='o') #散点为圆形，大小为10
    ...
    print(covarianceMatrix)
    print("attribute " + str(maxIndex_row+1) + " and attribute " + str(maxIndex_col+1) + " have the largest covariance and its value is " + str(covarianceMatrix[maxIndex_row][maxIndex_col]))
    print("attribute " + str(minIndex_row + 1) + " and attribute " + str(minIndex_col + 1) + " have the largest covariance and its value is " + str(covarianceMatrix[minIndex_row][minIndex_col]))
